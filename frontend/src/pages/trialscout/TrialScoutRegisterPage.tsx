...
export default function TrialScoutRegisterPage() {
    const navigate = useNavigate();
    const { register, isLoading, error, clearError } = useTrialScoutAuth();
            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-center mb-6">
                        Start exploring clinical trials
                    </p>
                    ...
                    <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <Link to="/trialscout/login" className="text-purple-600 hover:text-purple-700 font-medium">
                            Sign in
                        </Link>
                    </p>
                </div>
