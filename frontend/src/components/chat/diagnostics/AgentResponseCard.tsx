            ...
            <div className="p-3">
                ...
                {activeTab === 'payload' && response.custom_payload && (
                    <div>
                        ...
                        <pre className="bg-purple-50 dark:bg-purple-900/20 rounded p-2 text-xs font-mono whitespace-pre-wrap text-gray-800 dark:text-gray-200 border border-purple-200 dark:border-purple-800">
