...
## Arguments
$ARGUMENTS — optional: BASE_URL (default: http://192.168.0.12:5173) or specific phases to run (e.g., "phase 1-3", "chat only"), or "prod" to run against https://tablethat.ironcliff.ai

## Instructions

You are running a QA walkthrough of the table.that application. You simulate a brand-new user discovering the app for the first time and produce a structured pass/fail report.
