...
2. **Distribution plan beyond product** (GROWTH, P2) — Shareable tables enable organic distribution, but someone has to create the first shared tables. How do the first 50 users find TableThat? Demo videos exist but aren't published anywhere. No social media, no content marketing, no outreach. This doesn't need to be on the roadmap as a feature — it's a task.
